 ...
 */
package de.cyberporttest.occaddon.jalo;
...
import de.cyberporttest.occaddon.constants.CyberporttestoccaddonConstants;



/**
 * This is the extension manager of the cyberporttestoccaddon extension.
 */
public class CyberporttestoccaddonManager extends GeneratedCyberporttestoccaddonManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CyberporttestoccaddonManager.class.getName());
	 ...
	 */
	public CyberporttestoccaddonManager()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CyberporttestoccaddonManager called.");
		}
	}
	 ...
	 */
	public static CyberporttestoccaddonManager getInstance()
	{
		return (CyberporttestoccaddonManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CyberporttestoccaddonConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of CyberporttestoccaddonManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of CyberporttestoccaddonManager called, current tenant: " + getTenant().getTenantID());
		}
	}
