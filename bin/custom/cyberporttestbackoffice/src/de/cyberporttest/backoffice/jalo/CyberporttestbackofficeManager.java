 ...
 */
package de.cyberporttest.backoffice.jalo;
...
import de.cyberporttest.backoffice.constants.CyberporttestbackofficeConstants;
 ...
 */
public class CyberporttestbackofficeManager extends GeneratedCyberporttestbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(CyberporttestbackofficeManager.class.getName());
	 ...
	 */
	public static CyberporttestbackofficeManager getInstance()
	{
		return (CyberporttestbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(CyberporttestbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public CyberporttestbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of CyberporttestbackofficeManager called.");
		}
	}
