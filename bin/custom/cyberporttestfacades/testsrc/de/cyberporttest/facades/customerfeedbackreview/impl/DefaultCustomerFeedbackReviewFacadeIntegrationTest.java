...
@IntegrationTest
public class DefaultCustomerFeedbackReviewFacadeIntegrationTest extends AbstractCustomerFeedbackReviewTest {
    ...
    @Test
    public void testPagedDataOfReview() throws Exception {
        createCustomerFeedbackReviews(customer1, 3);
        SearchPageData searchPageData = getSearchPageData(0, 1, true, "rate", "asc");
        SearchPageData<CustomerFeedbackReviewData> reviewsOfCustomer = customerFeedbackReviewFacade.getReviewsOfCustomer(customer1.getUid(), searchPageData);
        ...
        assertTrue(reviewsOfCustomer.getResults().get(0).getCustomer().getUid().equals(customer1.getUid()));
    }

    @Test
    public void testEmptyResult(){
        SearchPageData searchPageData = getSearchPageData(0, 1, true, "rate", "asc");
        SearchPageData<CustomerFeedbackReviewData> reviewsOfCustomer = customerFeedbackReviewFacade.getReviewsOfCustomer(customer2.getUid(), searchPageData);
